                    ...
                    <ScrollView >
                        ...
                        <View>
                            ...
                            <View className="mt-[20px] px-[32px]">
                                ...
                                <Text className="text-[14px]">from your couch! Connect online with nearby</Text>
                                <Text className="text-[14px]">retailers now.</Text>
                            </View>
                            <View className="flex flex-col gap-[10px] mt-[40px]">
                                <View className="flex flex-col gap-[5px] px-[32px]">
                                    ...
                                    {/* <MobileIcon /> */}
                                    <Text className="text-[16px] font-extrabold">Please enter your</Text>
                                </View>
                                <View className="flex flex-col gap-[15px]">
                                    <Text className="text-[13px] font-normal px-[32px]">Mobile Number</Text>
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <ScrollView>
                        ...
                        <View className="px-[42px]">
                            ...
                            <View>
                                <Text className="text-[14px] text-[#2e2c43] pt-[24px]">Get the best price for your next purchase, Smart shopping is on now. </Text>
                            </View>
                            <View>
                            ...
                            <View className="mt-[14px]">
                                <Text className="text-[14px] text-[#2e2c43]">OTP should be auto-filled otherwise type it </Text>
