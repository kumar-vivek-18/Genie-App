...
import { View, Button, Image, Text, TouchableOpacity, TextInput, KeyboardAvoidingView } from 'react-native';
...
const CameraScreen = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            {imageUri && (
                <View style={{ flex: 1 }}>
                    <Image source={{ uri: imageUri }} style={{ width: '100%', height: '100%', position: 'absolute', top: 0, left: 0, right: 0, bottom: 0 }} />
