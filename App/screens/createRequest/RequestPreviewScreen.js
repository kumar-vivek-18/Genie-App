    ...
    <View style={{ flex: 1 }}>
      <View style={{ flex: 1 }}>
        <View className=" flex flex-row items-center mt-[50px] mb-[24px] px-[34px]">
          ...
          <Text className="flex flex-1 justify-center items-center text-center text-[16px] font-extrabold">
            Request Preview
          </Text>
        </View>
        <View className="px-[32px]">
          <Text className="text-[14px] font-extrabold text-[#2e2c43]">
            Splades of master
          </Text>
          <Text className="text-[14px] text-[#2e2c43] w-4/5 mt-[5px]">
            {requestDetail}
          </Text>
        </View>
        ...
        <View className="mx-[32px] mt-[50px] ">
          <Text className="font-bold text-[14px]  text-[#2e2c43]   mb-[6px]">
            Your expected price
          </Text>
          <Text className="text-[24px] font-extrabold text-[#558b2f] mb-[10px]">
            {expectedPrice} Rs
          </Text>
          <Text className="font-bold text-[14px] text-[#2e2c43] mb-[6px] ">
            Applied Coupon
