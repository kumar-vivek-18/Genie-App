              ...
              <View style={{ flex: 1, backgroundColor: "white" }}>
                ...
                <View className="pt-[8px] px-[40px]">
                  <Text className="text-[14px]">
                    Now bargaining is possible from your couch! Connect online
                    with nearby retailers now.
                  </Text>
                </View>
                <View className="flex flex-col gap-[16px] mt-[30px]">
                  ...
                  <View className="flex flex-col gap-[15px]">
                    <Text className="text-[12px] font-normal px-[40px]">
                      Mobile Number
                    </Text>
          ...
          <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
            <KeyboardAvoidingView behavior="position">
              ...
              <View className="px-[42px]">
                ...
                <View>
                  <Text className="text-[16px] text-[#2e2c43] pt-[10px]">
                    Community of your local sellers
                  </Text>
                </View>
                <View>
                  <Text className="text-[18px] font-bold text-[#001b33] pt-[24px]">
                    ENTER OTP
                  </Text>
                </View>
                <View>
                ...
                <View>
                  <Text className="text-[16px] text-[#2e2c43] mt-[15px]">
                    Didn't recieve it?
                  </Text>
                  <Text className="text-[14px] font-bold text-[#e76043] mt-[3px]">
                    RESEND
                  </Text>
                </View>
              </View>
